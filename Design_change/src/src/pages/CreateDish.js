...
export default class CreateDish extends Component {
  ...
  addQuantity() {
    if (this.state.quantity + 1 <= this.state.max) {
      ...
      //Toast.showWithGravity('You have reached the maximum limit of qty!', Toast.LONG, Toast.bottom)
    }
  }
            ...
            <View style={styles.container}>
              ...
              <KeyboardAvoidingView behavior="padding" enabled>
                ...
                <Dialog
                  ...
                  <View style={{ height: '100%' }}>
                    ...
                    <View style={{ flex: 1, width: 250, maxHeight: 180 }}>
                      <View style={{ flexDirection: 'row' }}>
              ...
              <View style={{ flex: 1, flexDirection: 'row', padding: 5 }}>
                <FlatList
                  ...
                  numColumns={8}
                  renderItem={({ item }) => (
                    <View style={{ width: width * 0.1238, alignSelf: 'center' }}>
                      {item.isgroup == true ? (
                        <View
                          style={{
                            flex: 1,
